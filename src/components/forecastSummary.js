...
console.log(icon);
  return (
    <h2>
      ...
      <div className="forecast-summary__temperature" data-testid="temperature-id">
      <span> {temperature}&deg;c </span>
      </div>
      <div className="forecast-summary__description" data-testid="description-id">
      ...
      <button onClick={() => handleForecastSelect(date)}>
        More Details
      </button>
